...
export const universalisTypes = {
  ...
  OneItemCurrentPrice: z.object({
    ...
    listings: z
      .array(
        z.object({
          ...
          materia: z.array(z.any()).optional(),
          onMannequin: z.boolean(),
          retainerCity: z.number(),
          retainerID: z.string().optional(),
          retainerName: z.string().optional(),
          sellerID: z.any(),
          total: z.number(),
          tax: z.number(),
        }),
    ...
    recentHistory: z
      .array(
        z.object({
          ...
          /** Unix timestamp in seconds */
          timestamp: z.number(),
          onMannequin: z.boolean().optional(),
          worldName: z.string().optional(),
          worldID: z.number().optional(),
    ...
    /** 當前拍賣中之 HQ 物品的最高價格 */
    maxPriceHQ: z.number(),
    stackSizeHistogram: z.record(z.string(), z.number()).optional(),
    stackSizeHistogramNQ: z.record(z.string(), z.number()).optional(),
    stackSizeHistogramHQ: z.record(z.string(), z.number()).optional(),
